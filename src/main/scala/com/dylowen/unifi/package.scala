...
/**
  ...
  * @since Aug-2018
  */
package object unifi {

  @volatile
  private var _unifiClientBackend: Option[SttpBackend[Future, Nothing]] = None


  def UnifiClientBackend(implicit nanoSystem: NanoSystem): SttpBackend[Future, Nothing] = {
  ...
  private def clientConfig(implicit nanoSystem: NanoSystem): AsyncHttpClientConfig = {
